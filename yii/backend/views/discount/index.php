...
<div class="page-header">
  <div class="row align-items-center mb-3">
    ...
    <div class="col-sm-auto">
      <?= Html::a('New Discount Code', ['create'], ['class' => 'btn btn-primary']) ?>
    </div>
  </div>
</div>
...
<div class="card">
  ...
  <div class="card-header card-header-content-md-between">
    ...
    'action' => Url::to(['/discount/multiple']),
    'method' => 'post',
]); ?>
    ...
    <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
      ...
      <thead class="thead-light">
        <tr>
          ...
          <th class="table-column-ps-0">Promo Code</th>
      ...
      <tbody>
        ...
        <?php foreach ($dataProvider->models as $model) : ?>
          ...
          <td class="table-column-pe-0">
            ...
            <td><?= Html::encode($model->promo_code) ?></td>
            <td><?= Html::encode($model->discount_percentage) . '%' ?></td>
            <td><?= Html::encode($model->insurance->name) ?></td>
            <td><?= Yii::$app->formatter->asDatetime($model->created_at, 'php:Y-m-d') ?></td>
            <td>
