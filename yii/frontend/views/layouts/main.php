...
<body>
    ...
    <div class="container px-3">
        <a class="navbar-brand" href="/"><img class="img-fluid" width="200"  height="150" src="<?= Yii::$app->request->baseUrl ?>/images/logo/logo-dark.png" alt="<?= Yii::t('app', '360Protect') ?>" /></a>
        ...
        <div class="offcanvas offcanvas-start offcanvas-nav" style="width: 20rem">
            <div class="offcanvas-header" >
                <a href="/" class="text-inverse"><img class="img-fluid" width="200"  height="150" src="<?= Yii::$app->request->baseUrl ?>/images/logo/logo-dark.png" alt="<?= Yii::t('app', '360Protect') ?>" /></a>
