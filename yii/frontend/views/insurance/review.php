...
<section class="pt-10 pb-10 bg-dark text-center">
    ...
    <span class="text-warning"><?= Yii::t('app', 'Review') ?></span>
    <?= Yii::t('app', 'Details') ?> - <?= Yii::t('app', 'New Insurance') ?>
</h1>
            </div>
        </div>
    </div>
...
<section class="mb-xl-9 my-5">
    ...
    <tr>
        ...
        <td><strong><?=Yii::$app->language == 'ar' ? $policy->insurance->name_ar:$policy->insurance->name?></strong></td>
        <td><?= Yii::t('app', 'Plan') ?></td>
        <td><strong><?=Yii::$app->language == 'ar' ?  $policy->plan->name_ar:  $policy->plan->name ?></strong></td>
    </tr>
    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="text-body" href="javascript:;" data-bs-toggle="modal" data-bs-target="#importProductsModal">
                                    <i class="bi bi-camera fs-5"></i> <?= Yii::t('app', 'Retake') ?>
                                </a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><span>Download the sample passport template to see an example of the format required for retaking your passport photo.</span></p>
