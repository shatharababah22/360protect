...
<!--Hero start-->
<section class="bg-primary-dark pt-8 "  data-cue="fadeIn">
    <div class="container">
    ...
    Explore a wide range of insurance options covering every aspect of your life, from health and travel to property and business. Select the type of insurance that fits your needs and continue to complete your policy purchase smoothly and confidently.
</p>
    ...
    <p class="mb-0 text-white">Edit your choices     <a href="javascript:void(0);" onclick="history.back();" class="btn btn-link text-warning px-0 me-3">
                 ...
                 <div class="offset-lg-<?= $languageDirection = Yii::$app->language == 'ar' ? 'rtl' : 'ltr' ?>-1 col-lg-6  col-12">
                    <div class="position-relative z-1 row pt-lg-9" data-cue="slideInRight">
                        ...
                        <?php foreach (\common\models\Insurances::find()->all() as $insurance): ?>
                <div class="col-md-3 mt-3 ZoomIn" data-cue="fadeIn">
                <a href="<?= Url::to(['/asurance/travel', 'id' => $insurance->id] + $data) ?>" class="card text-bg-light shadow zoom-img" data-cue="fadeUp">
                <img src="<?= Yii::$app->request->baseUrl ?>/dashboard/images/<?= $insurance->photo ?>" class="card-img" alt="img">
                        <div class="card-img-overlay text-white d-inline-flex justify-content-start align-items-end overlay-dark">
                            <div class="text-capitalize">
                                <!-- <h4 class="card-title"><?= $language === 'ar' ? $insurance->name_ar : $insurance->name ?></h4> -->
                    ...
                    </a>                        <p class="text-white mt-2"><?= $language === 'ar' ? $insurance->name_ar : $insurance->name ?></p>
